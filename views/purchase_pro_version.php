        ...
        <div class="layout-span12">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="#"><?php _e("Gallery Bank Pricing", gallery_bank); ?></a>
                </li>
            </ul>
            <div class="widget-layout">
                <div class="widget-layout-title">
                    <h4>
                        <i class="icon-plus"></i>
                        <?php _e("Gallery Bank Pricing", gallery_bank); ?>
                    </h4>
                </div>
                <div class="widget-layout-body">
		            <div class="fluid-layout">
		            	<div class="layout-span12">
							<!-- <div class="widget-layout" b> -->
								<div class="wpb_wrapper" style="margin-top: 10px;">
									<div id="Table_t1_s11" class="p_table_responsive p_table_1 p_table_1_11 css3_grid_clearfix">
