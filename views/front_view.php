							...
							if($pic_detail[$flag]->description == "")
							{
								...
								<br/>
									<div id="bank_pics_<?php echo $flag; ?>" style="padding: 10px; display: inline-block;">
										...
										<img src="<?php echo $pic_detail[$flag]->pic_path; ?>" style="border: <?php echo $album->border_width;?>px solid <?php echo $album->border_color;?>; height: <?php echo $album->image_height; ?>px; width: <?php echo $album->image_width; ?>px;" /></a>
									</div>
								<?php
								}
								else
